...
//        }
    ...
    private void addSettings() {
        ...
        XMBItem[] innerInnerSettings = new XMBItem[18];
        innerInnerSettings[0] = new XMBItem(null, "Add explorer item to home");
        innerInnerSettings[1] = new XMBItem(null, "Add application to home");
        innerInnerSettings[2] = new XMBItem(null, "Create new column");
        innerInnerSettings[3] = new XMBItem(null, "Add explorer item to home");
        innerInnerSettings[4] = new XMBItem(null, "Add application to home");
        innerInnerSettings[5] = new XMBItem(null, "Create new column");
        innerInnerSettings[6] = new XMBItem(null, "Add explorer item to home");
        innerInnerSettings[7] = new XMBItem(null, "Add application to home");
        innerInnerSettings[8] = new XMBItem(null, "Create new column");
        innerInnerSettings[9] = new XMBItem(null, "Add explorer item to home");
        innerInnerSettings[10] = new XMBItem(null, "Add application to home");
        innerInnerSettings[11] = new XMBItem(null, "Create new column");
        innerInnerSettings[12] = new XMBItem(null, "Create new column");
        innerInnerSettings[13] = new XMBItem(null, "Add explorer item to home");
        innerInnerSettings[14] = new XMBItem(null, "Add application to home");
        innerInnerSettings[15] = new XMBItem(null, "Create new column");
        innerInnerSettings[16] = new XMBItem(null, "Add explorer item to home");
        innerInnerSettings[17] = new XMBItem(null, "Add application to home");
